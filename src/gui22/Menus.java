...
public class Menus extends JFrame {
    ...
    class ML implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            if (actionCommand.equals("Open")) {
                ...
                for (String flavor : flavors) if (s.equals(flavor)) chosen = true;
    ...
    public Menus() {
        ...
        for (JCheckBoxMenuItem sfty : safety) s.add(sfty);
        ...
        for (JMenuItem oth : other) fooBar.add(oth);
