...
// : containers17/ListPerformance.java
...
public class ListPerformance {
    ...
    static {
                ...
                new Test<List<Integer>>("remove") {
                    int test(List<Integer> list, TestParam tp) {
                        ...
                        for (int i = 0; i < loops; i++) {
                            ...
                            while (list.size() > 5) list.remove(5); // Minimize random-access cost
                        }
                        return loops * size;
                    }
                });
        ...
        qTests.add(
                new Test<LinkedList<Integer>>("addFirst") {
        ...
        qTests.add(
                new Test<LinkedList<Integer>>("addLast") {
                    int test(LinkedList<Integer> list, TestParam tp) {
                        int loops = tp.loops;
                        int size = tp.size;
                        for (int i = 0; i < loops; i++) {
        ...
        qTests.add(
                new Test<LinkedList<Integer>>("rmLast") {
                    int test(LinkedList<Integer> list, TestParam tp) {
                        int loops = tp.loops;
                        int size = tp.size;
                        for (int i = 0; i < loops; i++) {
